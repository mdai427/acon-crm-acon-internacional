...
const ALLOWED_KEYS = new Set([
  ...
  // WhatsApp vía Labia (proveedor alternativo) y selector de proveedor saliente
  'WA_PROVIDER', 'LABIA_API_KEY', 'LABIA_WEBHOOK_SECRET', 'LABIA_BASE_URL',
  'LABIA_PHONE_NUMBER_ID', 'LABIA_SESSION_ID',
