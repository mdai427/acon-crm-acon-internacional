...
export const testLabia = () => api.post('/config/labia/test');
export const syncWaTemplates = () => api.post('/whatsapp/meta/templates/sync');
...
export const createMetaWaTemplate = (d) => api.post('/whatsapp/meta/templates', d);
export const uploadWaTemplateHeader = (file) => {
  const fd = new FormData();
  fd.append('file', file);
  return api.post('/whatsapp/meta/templates/media', fd);
};
